...
export const guidances = {
    ...
    budget: {
        ...
        alerts: [
            'Риск получения минимальной пенсии',
        ],
        description: {
            high: `<p>Откладывая деньги, вы создаёте финансовую подушку безопасности на будущее.</p>
                   <p>С сервисом <a href="/" className="tm-link-modal">Бюджет</a> в Сбербанк Онлайн вы сможете контролировать расходы и начать откладывать деньги.</p>`,
            medium: `<p>Откладывая деньги, вы создаёте финансовую подушку безопасности на будущее.</p>
                   <p>С сервисом <a href="/" className="tm-link-modal">Бюджет</a> в Сбербанк Онлайн вы сможете контролировать расходы и начать откладывать деньги.</p>`,
            low: `<p>Откладывая деньги, вы создаёте финансовую подушку безопасности на будущее.</p>
                   <p>С сервисом <a href="/" className="tm-link-modal">Бюджет</a> в Сбербанк Онлайн вы сможете контролировать расходы и начать откладывать деньги.</p>`,
        },
    },
    financialSecure: {
        ...
        alerts: [
            'Риск незапланированной траты в будущем',
        ],
        description: {
            high: `<p>У вас минимальный финансовый резерв</p>
            ...
            medium: `<p>У вас минимальный финансовый резерв</p>
                    <p>Если ваши доходы приостановятся на длительное время, то текущих денег будет недостаточно для сохранения привычного уровня жизни</p>`,
            low: `<p>У вас минимальный финансовый резерв</p>
                  <p>Если ваши доходы приостановятся на длительное время, то текущих денег будет недостаточно для сохранения привычного уровня жизни</p>`,
        },
    },
    investments: {
        ...
        description: {
            high: `<p>Постановка финансовых целей позволяет достигать задуманного быстрее</p>
            ...
            medium: `<p>Постановка финансовых целей позволяет достигать задуманного быстрее</p>
                    <p>С помощью сервиса Цели в Сбербанк Онлайн вы сможете сформировать и визуализировать свою цель, а также установить срок и способ ее достижения</p>`,
            low: `<p>Постановка финансовых целей позволяет достигать задуманного быстрее</p>
                    <p>С помощью сервиса Цели в Сбербанк Онлайн вы сможете сформировать и визуализировать свою цель, а также установить срок и способ ее достижения</p>`,
        },
    },
};
