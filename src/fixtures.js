    ...
    budget: {
        ...
        description: {
            high: `<p>Все хорошо.</p>
                   ...
                   <p>Начните откладывать еще больше с нашим сервисом <a href="/" class="tm-link-modal">Бюджет</a>.</p>`,
            medium: `<p>Все нормально.</p>
                   <p>Откладывая деньги, вы создаёте финансовую подушку безопасности на будущее.</p>
                   <p>С сервисом <a href="/" class="tm-link-modal">Бюджет</a> в Сбербанк Онлайн вы сможете контролировать расходы и начать откладывать деньги.</p>`,
            low: `<p>Все плохо.</p>
                   <p>Откладывая деньги, вы создаёте финансовую подушку безопасности на будущее.</p>
                   <p>С сервисом <a href="/" class="tm-link-modal">Бюджет</a> в Сбербанк Онлайн вы сможете контролировать расходы и начать откладывать деньги.</p>`,
        },
